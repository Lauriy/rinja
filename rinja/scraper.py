...
def retrieve_general_market_data_for_date(year: int, month: int, day: int):
...
#         bid = None
#         print(display_name, ticker, category, market, price_change_in_currency, price_change_percentage, close_price, last_price)
#
#     return []
#
